                        ...
                        {loading && false ? (
                            ...
                            sections?.sections.map(section => (
                                <tr key={section.id} className={` even:bg-gray-50 odd:bg-white hover:bg-gray-100 transition-colors`}>
                                    ...
                                    <td className="p-2 text-blue-700"><Link target='_blank' href={`https://planner.langaracs.ca/courses/${section.subject}/${section.course_code}`}>{section.subject} {section.course_code}</Link></td>
