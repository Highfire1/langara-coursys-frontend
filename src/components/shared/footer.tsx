...
const Footer: React.FC = () => {
    return (
        <footer className="w-full px-5 py-8 shadow-md bg-slate-400">
            ...
            <p>This project is open source! Check out the repository on <Link href="https://github.com/Highfire1/LangaraCoursePlanner" target='_blank' className='text-blue-800 hover:text-blue-600 underline font-medium'>Github</Link>.</p>
